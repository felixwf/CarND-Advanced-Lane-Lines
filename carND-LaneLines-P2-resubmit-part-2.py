...
def fit_polynomial(binary_warped):
    ...
    left_weight = 1/left_fit[2]
    right_weight = 1/right_fit[2]
    total_weight = left_weight + right_weight
    left_weight = left_weight / total_weight
    right_weight = right_weight / total_weight

    middle_fit = left_fit[0: 1] * left_weight + right_fit[0: 1] * right_weight
    left_fit[0: 1] = middle_fit[0: 1]
    right_fit[0: 1] = middle_fit[0: 1]
...
if __name__ == "__main__":
    ...
    output_video = 'project_video_output4.mp4'
